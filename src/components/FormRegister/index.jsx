    ...
    <form className="mt-2">
      <div className="row">
        <div className="col-md-6 d-flex flex-column">
          ...
          <div className="form-group mb-3 mx-auto">
            <input type="password" className="form-control form-control-lg custom-width largure-input text-center" id="password" placeholder="Senha" />
          </div>

          <div className="form-group mb-3 mx-auto">
            <input type="password" className="form-control form-control-lg custom-width largure-input text-center" id="ConfirmPassword" placeholder="Confirmar senha" />
          </div>
        </div>

        <div className="col-md-6 d-flex flex-column">
          <div className="form-group mb-3 mx-auto">
            <input type="email" className="form-control form-control-lg custom-width largure-input text-center" id="email" placeholder="E-mail" />
          </div>
          ...
          <div className="form-group mb-3 mx-auto">
            <select className="form-control form-control-lg largure-input text-center" id="selectUnit" placeholder="Selecione sua unidade">
