  ...
  return (
    <div className="bg-white">
      ...
      <div className="simulatorInfo">
        <p className="mt-3 text-white"> IBMEC 2022 ENADE - Direito</p>
      </div>
      ...
      <div className="d-flex justify-content-around questionsRightWrong">
        <div className="mt-5" style={{ width: 200, height: 200 }}>
          <CircularProgressbar
            ...
            value={rightsPercetage}
            text={`${rights} acertadas`}
          />
        </div>
        ...
        <div>
              ...
              <div className="d-flex flex-wrap">
                {questions.slice(0, 20).map((questionNumber) => (
                  <div key={questionNumber} className="question-circle">
                    <div
                      className={`circle ${
                        wrongsAnswers.includes(questionNumber)
                          ? "bg-danger"
                          : ""
                      }`}
                    >
          ...
          <div className="mt-4">
            <button
              className="buttonBack rounded border-0"
